...
const DangerZone = () => {
                ...
                { text: "Cancel", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            ...
                            Alert.alert(
                                "App reset",
                                `Successfully deleted ${result.deletedCount} todos${result.deletedCount === 1 ? "" : "s"}. Your app has been reset.`
                            )
                        } catch (error) {
    ...
    return (
        <LinearGradient
            colors={colors.gradients.surface} style={settingsStyles.section}
        >
